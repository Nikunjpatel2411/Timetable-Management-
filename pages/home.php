  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<p>Input Subject Code: <input type="text" name="sub_code" id="sub_code" style="width: 100px; height: 20px;"></p>						
		<div id="tableContainer"></div>
		<script>
			document.getElementById('sub_code').addEventListener('input', function() {
						  ...
						  <div class="form-group">
							<label for="date">Teacher</label>
								...
								<select class="form-control select2" name="teacher" required>
								  ...
								  ?>
										<option value="<?php echo $row['member_id'];?>"><?php echo $row['member_first']." ".$row['member_last'].", ".$row['member_id'];$mem_id=$row['member_id'];?></option>
